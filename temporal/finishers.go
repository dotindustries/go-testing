...
func WorkflowFinished() func(s **TemporalWorkflowTestSuite) {
	return func(s **TemporalWorkflowTestSuite) {
		st := *s
...
func WorkflowContinuedAsNew() func(s **TemporalWorkflowTestSuite) {
	return func(s **TemporalWorkflowTestSuite) {
		st := *s
		st.True(st.Env.IsWorkflowCompleted())
...
func WorkflowErrored(expectedErrMsg string) func(suite **TemporalWorkflowTestSuite) {
	return func(suite **TemporalWorkflowTestSuite) {
		st := *suite
		st.True(st.Env.IsWorkflowCompleted())
		err := st.Env.GetWorkflowError()
...
func WorkflowTimedOut(start time.Time, expectedTimeout time.Duration) func(s **TemporalWorkflowTestSuite) {
	return func(s **TemporalWorkflowTestSuite) {
		st := *s
